...
#define SYS_PORT_B_ANSEL        0xD009
#define SYS_PORT_B_TRIS         0xF3D9
...
/*** Functions for U1RTS_MANUAL_PIC_OUT pin ***/
#define U1RTS_MANUAL_PIC_OUTToggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_11)
#define U1RTS_MANUAL_PIC_OUTOn() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_11)
#define U1RTS_MANUAL_PIC_OUTOff() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_11)
#define U1RTS_MANUAL_PIC_OUTStateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_11)
#define U1RTS_MANUAL_PIC_OUTStateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_11, Value)

/*** Functions for U1CTS_MANUAL_PIC_IN pin ***/
#define U1CTS_MANUAL_PIC_INStateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_A, PORTS_BIT_POS_1)
